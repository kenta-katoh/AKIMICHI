...
namespace Akimichi.Game
{
    public class ResultDataManager : ManagerBase<ResultDataManager>
    {
        ...
        /// </summary>
        /// <param name="index"></param>
        public void SetDiceCount(GameConst.PlayerIndex index, int value)
        {
            if (this.resultDic.ContainsKey(index))
            {
                this.resultDic[index].DiceCount = value;
            }
        }
        ...
        /// <param name="index"></param>
        /// <param name="type"></param>
        public void SetMapSpace(GameConst.PlayerIndex index, GameConst.MapSpaceType type, int value)
        {
            if (this.resultDic.ContainsKey(index))
            {
                switch (type)
                {
                    case GameConst.MapSpaceType.Plus:
                        this.resultDic[index].PlusCount = value;
                        break;
                    case GameConst.MapSpaceType.Minus:
                        this.resultDic[index].MinusCount = value;
                        break;
                    case GameConst.MapSpaceType.Event:
                        this.resultDic[index].EventCount = value;
                        break;
                }
            }
        }
        ...
        /// <param name="index"></param>
        /// <param name="value"></param>
        public void SetMoveValue(GameConst.PlayerIndex index, int value)
        {
            if (this.resultDic.ContainsKey(index))
            {
                this.resultDic[index].MoveValue = value;
        ...
        /// </summary>
        /// <param name="index"></param>
        public void SetPracticeCount(GameConst.PlayerIndex index, int value)
        {
            if (this.resultDic.ContainsKey(index))
            {
                this.resultDic[index].PracticeCount = value;
            }
        }
    }
}
